...
const images = [
  ...
  "https://is1-ssl.mzstatic.com/image/thumb/Music114/v4/8c/ca/36/8cca3624-680a-b769-5b26-60efb4ff6deb/886448655909.jpg/800x800cc.jpg",
  "https://i.ytimg.com/vi/vY5latW_RGs/maxresdefault.jpg",                
  "https://cdn.wrytin.com/images/thumbnail/r/400/chaar-kadam-lyrics-in-hindi-lwje11tx.jpeg",     
  "https://c-fa.cdn.smule.com/rs-s-sf-4/arr/18/c5/53eb7163-9866-47ef-b211-76a0c9d37e63.jpg",                                          
  "https://i.ytimg.com/vi/Achfeohm57k/hq720.jpg?sqp=-oaymwEcCNAFEJQDSFXyq4qpAw4IARUAAIhCGAFwAcABBg==&rs=AOn4CLBhQ6M2zvFA91AON-De3QSEBpjlJw",
  "https://i.scdn.co/image/ab67616d0000b273352f44aed6f226c6ea28b961",                                   
  "https://i.ytimg.com/vi/QQVXHojMzN0/maxresdefault.jpg",                         
  "https://i.ytimg.com/vi/toEGnF5fZyg/hqdefault.jpg",        
  "https://c.saavncdn.com/703/Pal-Pal-Dil-Ke-Paas-Remix-By-Dj-Nitish-Hindi-2020-20201022134937-500x500.jpg",         
  "https://i.ytimg.com/vi/T32BfZnnPUQ/maxresdefault.jpg",                      
  "https://i.ytimg.com/vi/YYeG_cW0Om0/maxresdefault.jpg",                                                        
...
const songs = [
  ...
  //-----hindi
     { title: "Bhaag D.K. Bose",        artist: "Ram Sampath",      src: "./ALL-songs/Bhaag-DK-Bose.mp3",    cover: images[9] },     
  { title: "Bulleya'",         artist: "Amit Mishra",        src: "./ALL-songs/Bulleya.mp3",      cover: images[10] },                
  { title: "Chaar kadam",         artist: "Shaan and Shreya Ghoshal",    src: "./ALL-songs/chaar-kadam.mp3",    cover: images[11] }, 
  { title: "Haal Kaisa Hai JanabKa",  artist: "Kishor Kumar",      src: "./ALL-songs/Haal-Kaisa-Hai-JanabKa.mp3", cover: images[12] },
  { title: "Jane Kahan Mera Jigar GayaJi",  artist: "Geeta Ghosh Roy Chowdhuri", src: "./ALL-songs/Jane-Kahan-Mera-Jigar-GayaJi.mp3",  cover: images[13] },
  { title: "Kyon",         artist: "Sunidhi Chauhan Papon Pritam",        src: "./ALL-songs/Kyon.mp3",                     cover: images[14] },            
  { title: "Main Pal Do Pal Ka Shair hoon",         artist: "Mukesh",    src: "./ALL-songs/Main-Pal-Do-Pal-Ka-ShairHoon.mp3",     cover: images[15] },    
  { title: "Raanjhanaa",  artist: "Arijit Singh",      src: "./ALL-songs/Raanjhanaa.mp3",                     cover: images[16] },
  { title: "Pal Pal Dil Ke Paas",      artist: "Kishore Kumar",          src: "./ALL-songs/Pal-Pal-Dil-Ke-Paas.mp3",  cover: images[17] },
  { title: "Itna na mujhse tu pyar badha",      artist: "Lata Mangeshkar and Talat Mahmood",          src: "./ALL-songs/Itna-na-mujhse-tu-pyar-badha.mp3",  cover: images[18] },
  { title: "Taarif Karoon KyaUski",      artist: "Mohammed Rafi",          src: "./ALL-songs/Taarif-Karoon-KyaUski.mp3",  cover: images[19] },
    //--------marathi
  
  { title: "", artist: "", src: "./ALL-songs/.mp3", cover: images[20] },
  { title: "", artist: "", src: "./ALL-songs/.mp3", cover: images[21] },
  { title: "", artist: "", src: "./ALL-songs/.mp3", cover: images[22] },
  { title: "", artist: "", src: "./ALL-songs/.mp3", cover: images[23] },
  { title: "", artist: "", src: "./ALL-songs/.mp3", cover: images[24] }
...
//   if (menuOpen) {
//     menuBtn.innerHTML = '<i class="fa-solid fa-xmark"></i>'; // show X
//   } else {
//     menuBtn.innerHTML = '<i class="fa-solid fa-bars"  style="color:white;"></i>'; // show bars
//   }
// });
...
//     menuBtn.innerHTML = '<i class="fa-solid fa-bars" style="color:white;"></i>'; // reset to bars
//     menuOpen = false;
//   });
// });
...
//   if (isPlaying) {
//     toggle.active();
//     playBtn.innerHTML = '<i class="fa-solid fa-bars"></i>';
//   } else {
//     audio.play();
//     playBtn.innerHTML = '<i class="fa-solid fa-xmark"></i>';
//   }
//   isPlaying = !isPlaying;
// }
